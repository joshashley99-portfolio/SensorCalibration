...
Addtionally I've not programmed an edge case scenario where the sensor is stuck reading the same number for each phase.  Meaning it's detecting 0% o2 as the same as 30% o2.  That would break the program and I am aware.  It is something I have considered and will loop back to implement when I have a bit more time. 
